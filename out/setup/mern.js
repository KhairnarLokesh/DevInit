...
`;
    (0, fileUtils_1.createFile)(path.join(projectPath, 'package.json'), rootPackageJson);
...
`;
    (0, fileUtils_1.createFile)(path.join(projectPath, 'setup-ui.js'), setupUiScript);
    // Automation
